# -*- coding: utf-8 -*-
"""
Created on Tue Apr 16 09:04:24 2019

File for saving the centre pt and radius of particles. DIfferent to the last file becuase the files aren't chosen at 
random, they are consecutive frames for developing tracking algorithm.
...
#                n2 = '' + str(n)
            ...
            txt_file = open(path + "particles2.txt","a")
            for i in range(0,len(centre_x)):
